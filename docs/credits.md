...
Code and documentation in this repository are MIT licensed (see [`LICENSE`](https://github.com/lethevimlet/lethe-bc250/blob/main/LICENSE)); the same terms
apply to the ESP32 firmware and to `bc250-tune`. The case STLs in [`printed-case/`](https://github.com/lethevimlet/lethe-bc250/tree/main/printed-case/) are CC BY-SA by MrLarva.
